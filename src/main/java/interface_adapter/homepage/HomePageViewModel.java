...
public class HomePageViewModel extends ViewModel<HomePageViewState> {
    ...
    public static final String APP_LABEL = "Hello! Welcome to StudyBuddyFinder! Our application aims to pair students with study partners, who have similar courses, programs, and availability to enhance academic performance of our users.\n";
